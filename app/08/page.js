  ...
  return (
    <div>
      ...
      <div className="space-y-8 px-6 py-8">
        ...
        {/* Tree Myths, Legends, and Symbolism */}
        <section>
          <h2 className="text-lg font-medium text-gray-900">Tree Myths, Legends, and Symbolism:</h2>
          <div className="mt-4 space-y-4 text-gray-700">
            <div>
              <h3 className="text-md font-semibold text-gray-800">Celtic Tree Calendar:</h3>
              <ul className="list-disc pl-5">
                <li>
                  Highlight the Druids' reverence for trees like Oak, Hazel, and Holly, each representing different phases of the lunar calendar.
                </li>
              </ul>
            </div>

            <div>
              <h3 className="text-md font-semibold text-gray-800">World Trees:</h3>
              <ul className="list-disc pl-5">
                <li>
                  In Norse mythology, Yggdrasil is the cosmic tree that connects the heavens, earth, and underworld.
                </li>
              </ul>
            </div>

            <div>
              <h3 className="text-md font-semibold text-gray-800">Tree Spirits and Dryads:</h3>
              <ul className="list-disc pl-5">
                <li>
                  Ancient cultures believed trees housed spirits, with certain trees like willows and cedars considered sacred.
                </li>
              </ul>
            </div>
          </div>
